...
.. warning::
    ...
    ``aiootp`` is **experimental software** that works with Python 3.10+. It's a work in progress. Its algorithms & programming API are likely to change with future updates, & it isn't bug free.
