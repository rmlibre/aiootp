...
SEED_KDF_BLOCKSIZE = SEED_KDF_TYPE().block_size
...
LEFT_KDF_BLOCKSIZE = LEFT_KDF_TYPE().block_size
LEFT_RATCHET_KEY_SLICE = slice(0, None, 2)  # Even index bytes

RIGHT_KDF_BLOCKSIZE = RIGHT_KDF_TYPE().block_size
RIGHT_RATCHET_KEY_SLICE = slice(1, None, 2)  # Odd index bytes

SHMAC_BLOCKSIZE = SHMAC_TYPE().block_size
